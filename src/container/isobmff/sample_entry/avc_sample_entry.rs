...
mod tests {
  ...
  fn test_build_avc1_sample_entry() {
    let expected_avc1_sample_entry = vec![
      0x00, 0x00, 0x00, 0x86, 0x61, 0x76, 0x63, 0x31, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  ...
  #[test]
  fn test_build_avc1_sample_entry_sample_entry_missing() {
    let sps: [u8; 25] = [
      0x67, 0x42, 0xC0, 0x1E, 0xD9, 0x01, 0xE0, 0x8F, 0xEB, 0x01, 0x10, 0x00, 0x00, 0x03, 0x00, 0x10, 0x00, 0x00, 0x03, 0x03, 0xC0, 0xF1, 0x62, 0xE4, 0x80
    ];
    let pps: [u8; 4] = [
    ...
    match avc1_sample_entry {
        Ok(_) => {}
        Err(err) => {
          assert_eq!(err.major, MajorCode::REMUX);
          assert_eq!(err.minor, RemuxMinorCode::MISSING_BUILDER_DEPENDENCY_ERROR as u8);
        }
    }
  }

  #[test]
  fn test_build_avc1_sample_entry_visual_sample_entry_missing() {
    let sps: [u8; 25] = [
      0x67, 0x42, 0xC0, 0x1E, 0xD9, 0x01, 0xE0, 0x8F, 0xEB, 0x01, 0x10, 0x00, 0x00, 0x03, 0x00, 0x10, 0x00, 0x00, 0x03, 0x03, 0xC0, 0xF1, 0x62, 0xE4, 0x80
    ];
    let pps: [u8; 4] = [
  ...
  #[test]
  fn test_build_avc1_sample_entry_avcc_missing() {
    let sps: [u8; 25] = [
      0x67, 0x42, 0xC0, 0x1E, 0xD9, 0x01, 0xE0, 0x8F, 0xEB, 0x01, 0x10, 0x00, 0x00, 0x03, 0x00, 0x10, 0x00, 0x00, 0x03, 0x03, 0xC0, 0xF1, 0x62, 0xE4, 0x80
    ];
    let avc1_sample_entry = AVCSampleEntryBuilder::create_builder()
