...
impl SIDX {
  ...
  pub fn parse_sidx(sidx_data: &[u8]) -> Result<SIDX, CustomError> {
...
mod tests {
  ...
  fn test_parse_sidx() {
    let sidx:[u8; 164] = [
      ...
      // sidx
      
    ];
    let expected_sidx: SIDX = get_test_sidx();
    assert_eq!(SIDX::parse(&sidx).unwrap(), expected_sidx);
  }
}